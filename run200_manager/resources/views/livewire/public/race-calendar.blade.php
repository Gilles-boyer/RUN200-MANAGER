                                ...
                                @foreach($this->pastRaces as $race)
                                    <tr class="hover:bg-carbon-50 dark:hover:bg-carbon-800/50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            @if($race->isPublished() && $race->results_count > 0)
                                                <a href="{{ route('public.results.race', $race) }}" class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 hover:underline">
