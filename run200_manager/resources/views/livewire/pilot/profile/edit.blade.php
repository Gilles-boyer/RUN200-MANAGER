            ...
            <div class="flex flex-col sm:flex-row items-start gap-6">
                ...
                <div class="flex-1">
                    ...
                    <div wire:loading wire:target="photo" class="mt-4">
                        <div class="flex items-center gap-3 p-4 bg-racing-red-50 dark:bg-racing-red-900/20 rounded-xl border border-racing-red-200 dark:border-racing-red-800">
                            <div class="flex-shrink-0">
                                <svg class="animate-spin h-6 w-6 text-racing-red-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                </svg>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-racing-red-700 dark:text-racing-red-400">Chargement de la photo en cours...</p>
                                <p class="text-xs text-racing-red-600 dark:text-racing-red-500">Veuillez patienter</p>
                            </div>
                        </div>
                    </div>

                    @if($photo)
                        <div class="mt-4" wire:loading.remove wire:target="photo">
