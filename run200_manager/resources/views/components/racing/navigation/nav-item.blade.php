{{--
    Racing Navigation Item Component
...
@php
    ...
    $icons = [
        ...
        'car' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7M5 16h14M7 9V5a2 2 0 012-2h6a2 2 0 012 2v4"/>',
        ...
        'trophy' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>',
...
<a
    ...
    @class([
        ...
        'bg-racing-red-500 text-white shadow-racing' => $isActive,
        'text-carbon-600 dark:text-carbon-400 hover:bg-carbon-100 dark:hover:bg-carbon-800 hover:text-carbon-900 dark:hover:text-white' => !$isActive,
    ])
>
    {{-- Icon --}}
    <span @class([
    ...
    @if($badge)
        <span @class([
            ...
            'bg-racing-red-100 text-racing-red-600 dark:bg-racing-red-900/30 dark:text-racing-red-400' => !$isActive,
        ])>
            {{ $badge }}
        </span>
    @endif
