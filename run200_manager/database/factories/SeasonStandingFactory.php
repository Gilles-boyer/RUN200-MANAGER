...
class SeasonStandingFactory extends Factory
{
    ...
    /**
     * Create a standing without rank (not eligible - less than 2 races)
     */
    ...
    /**
     * Create a standing with bonus (all races participated)
     */
    ...
    /**
     * Create a standing without bonus
     */
    public function withoutBonus(): static
    {
        return $this->state(fn (array $attributes) => [
            'bonus_points' => 0,
            'total_points' => $attributes['base_points'],
        ]);
    }

    /**
     * Create a champion (1st place)
     */
    public function champion(): static
    {
        return $this->state(fn (array $attributes) => [
            'races_count' => 5,
            'base_points' => 125, // 5 wins
            'bonus_points' => 20,
            'total_points' => 145,
            'rank' => 1,
        ]);
